...
public class ChatInterfacePerso extends JFrame {
    ...
    //atrakva chatcontrolleer et chatpersoui
    ...
    public void afficheMessage(){
        ...
        if(lastMessageJSON != null && !lastMessageJSON.isEmpty()){
            ...
            try {
                ...
                appendFormattedMessage(from, content, isPrivate);
    ...
    // atrakva chatpersoui => updateUserList(Map<String, String> userMap)
    ...
    //atrakva userColorManager, majd hivom a chatperoui-ben
    ...
    //atrakva chatcontroller => envoyerStatut(String selection)
    //atrakva chatpersoui => updateLocalUserStatus(String pseudo, String state)
    ...
    // atrakva => extraire dans la classe UserStatusRenderer
    ...
    //Méthode principale pour la ChatInterfacePerso
    //atrakva chatpersoui
